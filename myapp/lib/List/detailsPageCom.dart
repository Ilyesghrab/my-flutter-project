...
class DetailsPageCom extends StatefulWidget {
  final designation;
  final barCode;
  final quatite;
  final reference;
  ...
  DetailsPageCom(
      {this.designation, this.barCode, this.quatite, this.reference});

  @override
  _DetailsPageComState createState() => _DetailsPageComState();
}

class _DetailsPageComState extends State<DetailsPageCom> {
