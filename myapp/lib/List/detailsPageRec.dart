...
class DetailsPageRec extends StatefulWidget {
  final designation;
  final emplacement;
  final quatite;
  final article;
  ...
  DetailsPageRec(
      {this.designation, this.emplacement, this.quatite, this.article});

  @override
  _DetailsPageRecState createState() => _DetailsPageRecState();
}

class _DetailsPageRecState extends State<DetailsPageRec> {
