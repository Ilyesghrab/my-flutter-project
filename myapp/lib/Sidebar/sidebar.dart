...
import 'package:myapp/Sidebar/menu_item.dart';
                    ...
                    children: <Widget>[
                      ...
                      MenuItem(
                        ...
                        onTap: () {
                          onIconPressed();
                          BlocProvider.of<NavigationBloc>(context)
                              .add(NavigationEvents.MyListClickedEvent);
                        },
                      ),
                      MenuItem(
                        icon: Icons.qr_code,
                        ...
                        onTap: () {
                          onIconPressed();
                          BlocProvider.of<NavigationBloc>(context)
                              .add(NavigationEvents.MyScannerClickedEvent);
                        },
                      ),
                      Divider(
                        height: 64,
                      ...
                      MenuItem(
                        ...
                        onTap: () {
                          onIconPressed();
                          BlocProvider.of<NavigationBloc>(context)
                              .add(NavigationEvents.MyLogOutClickedEvent);
                        },
                      ),
                    ],
                  ),
