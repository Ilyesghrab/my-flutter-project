...
import 'package:myapp/Views/pages/AddTrans.dart';
...
class ListTransferLine extends StatefulWidget with NavigationStates {
  String idTrans;
  bool reception;
  bool expedition;
  ListTransferLine(this.idTrans, this.reception, this.expedition);
  @override
  ListTransferLineState createState() => ListTransferLineState();
}

class ListTransferLineState extends State<ListTransferLine>
  ...
  Future<List<TransferL>> getTline;
  ...
  Future<List<TransferL>> getlistC() async {
    try {
      String config = "<cab:noTransfert>${widget.idTrans}</cab:noTransfert>" +
      ...
      List<TransferL> t = await ws.getTransferLine();
      int n = t.length;
      print(n.toString());
      if (t == null) {
        setState(() {
                    ...
                    child: Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            buildSearch(),
                            Expanded(
                                child: FutureBuilder<List<TransferL>>(
                                    future: getTline,
                                    builder: (BuildContext context,
                                        AsyncSnapshot<List<TransferL>>
                                            snapshot) {
